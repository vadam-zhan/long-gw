...
import (
	...
	"github.com/vadam-zhan/long-gw/internal/connector/downstream"
	"github.com/vadam-zhan/long-gw/internal/connector/upstream"
...
type WorkerPool struct {
	...
	downstreamRouter downstream.DownstreamRouterInterface // 下行，kafka 消费后消息写入tcp，todo 未来扩展成支持 grpc 也写入 tcp
}

// NewWorkerPool 创建 worker 池
func NewWorkerPool(svc *svc.ServiceContext, businessType gateway.BusinessType, sender upstream.Sender, router downstream.DownstreamRouterInterface) *WorkerPool {
