...
type Consumer struct {
	...
	pools     map[gateway.BusinessType]connector.WorkerPoolInterface
...
func NewConsumer(cfg *config.KafkaConfig, pools map[gateway.BusinessType]connector.WorkerPoolInterface, topics []string) *Consumer {
