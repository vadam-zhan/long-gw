...
const file_gateway_v1_common_proto_rawDesc = "" +
	...
	"\x04type\x18\x02 \x01(\x0e2\x15.gateway.v1.FrameTypeR\x04type\x12\x15\n" +
	...
	"\texpire_at\x18\t \x01(\x03R\bexpireAt\x12\x19\n" +
	"\bbiz_code\x18\n" +
	" \x01(\tR\abizCode\x12=\n" +
	...
	"\x04body\x18\r \x01(\v2\x10.gateway.v1.BodyR\x04body\x1a:\n" +
